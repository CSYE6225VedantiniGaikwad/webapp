...
public class SecurityConfig {
    ...
    public SecurityFilterChain filter ( HttpSecurity httpSecurity ) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize.requestMatchers("/v1/assignments/*", "/v1/assignments", "/v1/assignments/*/submission","/v2/assignments/*/submission", "/v2/assignments", /v2/assignments/*").authenticated())
